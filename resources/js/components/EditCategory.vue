      ...
      <div class="form-group">
        ...
        <div class="d-flex justify-content-between">
          <select
            ...
            v-model="selected"
          >
            <option value="#3FB1CE">Défaut</option>
...
export default {
  data() {
    return {
      ...
      selected: this.category.marker,
      markerColor: this.category.marker,
      csrf: document
  ...
  methods: {
    ...
    checkName(event) {
      ...
      if (this.namesArray.indexOf(name) !== -1 && this.category.name !== name) {
